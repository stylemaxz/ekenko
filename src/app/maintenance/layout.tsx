...
import { Home, ClipboardList, Wrench, User, Menu, X } from 'lucide-react';
...
export default function MaintenanceLayout({
  ...
  const navItems = [
    { icon: Home, label: t('nav_maintenance_dashboard'), path: '/maintenance/dashboard' },
    { icon: ClipboardList, label: t('nav_my_tasks'), path: '/maintenance/my-tasks' },
    { icon: Wrench, label: t('nav_all_tasks'), path: '/maintenance/tasks' },
    { icon: User, label: t('profile'), path: '/maintenance/profile' },
  ];
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <aside className={clsx(
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-200 bg-slate-50">
          <p className="text-xs text-slate-500 text-center">© 2026 Ekenko</p>
        </div>
      </aside>
