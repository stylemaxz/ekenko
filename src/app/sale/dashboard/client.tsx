...
export default function SaleDashboardClient({ initialData, currentUser }: SaleDashboardClientProps) {
  ...
  // Mock Current User (Sales Rep) - Passed from Server
    ...
    <div className="pb-24">
      ...
      <div className="bg-white p-6 pb-8 rounded-b-3xl shadow-sm border-b border-slate-100">
        <div className="flex justify-between items-start mb-6">
          ...
          <button 
            onClick={() => router.push('/sale/profile')}
            className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center font-bold text-slate-600 border border-slate-200 overflow-hidden relative hover:ring-2 hover:ring-primary/20 transition-all active:scale-95 cursor-pointer"
          >
            {currentUser.avatar ? (
