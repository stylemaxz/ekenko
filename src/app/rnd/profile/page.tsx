...
import { LogOut, ChevronRight, Globe, User, Edit, Save, Camera, Mail, Phone, Lock, FlaskConical } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import { useToast } from "@/contexts/ToastContext";
import { clsx } from "clsx";

export default function RndProfilePage() {
       ...
       <div className="relative group">
               ...
               {!isEditing && (
                   <div className="text-center mt-4">
                       ...
                       <p className="text-slate-500 capitalize">{t('role_rnd')}</p>
                   </div>
               )}
           </div>
